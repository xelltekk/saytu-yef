  ...
  return (
    <Card className="col-span-full lg:col-span-2">
      <div className="flex items-center justify-between mb-4">
        <h3 className="text-sm font-semibold text-[#f0f2f8]">Activité Récente</h3>
        <a href="/sales" className="text-xs text-[#4f6ef7] hover:text-[#3d5ce5] transition-colors">Voir tout</a>
      </div>
      ...
      {loading ? (
        ...
        <div className="flex flex-col items-center justify-center py-10 text-[#8892aa]">
        ...
        <div className="flex flex-col gap-2">
          {sales.map((sale) => (
            <div key={sale.id} className="flex items-center gap-3 p-3 rounded-xl hover:bg-white/[0.03] transition-colors">
              <div className="w-9 h-9 rounded-xl bg-[#4f6ef7]/10 flex items-center justify-center flex-shrink-0">
                <ShoppingBag size={16} className="text-[#4f6ef7]" />
              </div>
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2">
                  <p className="text-sm text-[#f0f2f8] font-medium truncate">
              ...
              <div className="text-right flex-shrink-0">
                <p className="text-sm font-semibold text-[#f0f2f8]">{formatCurrency(sale.total)}</p>
