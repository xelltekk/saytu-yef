    ...
    <div className="min-h-screen gradient-bg flex items-center justify-center p-4">
      ...
      <div className="w-full max-w-md relative z-10">
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-[#6B7682]">Choisissez un mot de passe securise</p>
        </div>
        ...
        <div className="rounded-3xl border border-[#2D7D7D]/[0.08] bg-white p-6 shadow-[0_12px_40px_rgba(26,54,54,0.08)]">
          {success ? (
            <div className="text-center py-4 space-y-4">
              ...
              <div>
                <p className="text-sm text-[#1A3636] font-medium">Mot de passe mis a jour !</p>
            ...
            <div className="text-center py-8 space-y-3">
              ...
              <p className="text-sm text-[#5C6B73]">Verification du lien en cours...</p>
              <p className="text-xs text-[#6B7682]">
                Si la page reste bloquee, le lien a peut-etre expire.{' '}
                <Link href="/forgot-password" className="text-[#6C5CE7] hover:underline">
                  Renvoyer un lien
                </Link>
              </p>
            </div>
