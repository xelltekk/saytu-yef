...
CREATE TABLE IF NOT EXISTS public.subscription_requests (
  ...
  business_name TEXT,
  current_plan TEXT NOT NULL CHECK (current_plan IN ('free', 'starter', 'pro', 'enterprise', 'lifetime')),
  requested_plan TEXT NOT NULL CHECK (requested_plan IN ('free', 'starter', 'pro', 'enterprise', 'lifetime')),
